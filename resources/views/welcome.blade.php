...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <p class="mt-1 text-gray-600 poppins-medium">{{ __('News Description') }}</p>
        </div>
        <!-- End Title -->
        ...
        <section class="bg-white">
            <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-black md:text-4xl nunito-sans-bold">{{ __('AirportImports') }}</h2>
        ...
        <div  class="fixed bottom-0 end-0 z-60 sm:max-w-xl w-full mx-auto p-6 hs-overlay">
            <!-- Card -->
            <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                ...
                <div class="grow">
                    ...
                    {{ __('CookiesDescription') }}
                    </p>
                    <div class="mt-5 inline-flex gap-x-2">
                    <a id="cookies-accept" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none cursor-pointer">
                        {{ __('CookiesAccept') }}
                    </a>
                    <a href="{{ route('cookies.policy') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none cursor-pointer">
                        {{ __('CookiesManage') }}
                    </a>
                    </div>
                </div>
        ...
        <script is:inline>
            ...
            document.getElementById('cookies-accept').addEventListener('click', function() {
                try {
                    ...
                    console.error('Error saving cookies preference:', error);
                }
            });
        </script>
