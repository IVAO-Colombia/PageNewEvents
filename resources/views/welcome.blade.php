...
<body>
    ...
    <section class="bg-white">
        <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2
                class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-black md:text-4xl nunito-sans-bold">
                {{ __('AirportImports') }}</h2>
            <div
    ...
    <div class="fixed bottom-0 end-0 z-60 sm:max-w-xl w-full mx-auto p-6 hs-overlay">
        ...
        <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
            <div class="flex gap-x-5">
                <svg class="hidden sm:block shrink-0 w-20" width="72" height="63" viewBox="0 0 72 63" fill="none"
                    ...
                    <path
                        ...
                        stroke="currentColor" class="" stroke-width="2" stroke-linecap="round" />
                    <path
                    ...
                    <ellipse rx="2.96295" ry="3.45694"
                        transform="matrix(0.855131 0.518411 -0.509711 0.860345 30.4996 41.3871)" fill="currentColor"
                        class="text-gray-800" />
                    <path
                ...
                <div class="grow">
                    ...
                    <div class="mt-5 inline-flex gap-x-2">
                        <a id="cookies-accept" type="button"
