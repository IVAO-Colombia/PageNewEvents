...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <div id="global-preloader" style="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;
                    background:#ffffff;z-index:9999;transition:opacity .35s ease">
        <img src="{{ asset('assets/loading/loading_rfe.gif') }}" alt="Loading"
    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="document-magnifying-glass" :href="route('dashboard')"
            ...
            <flux:navlist.item icon="magnifying-glass"
                :href="route('search.bookings', ['event' => request()->route('event')])"
            ...
            @endif
            <flux:navbar.item icon="document-text" :href="route('reservation')"
                :current="request()->routeIs('reservation')">
                {{ __('My Reservations') }}
            </flux:navbar.item>
            <flux:navbar.item icon="calendar-days" :href="route('controller')"
                :current="request()->routeIs('controller') || request()->routeIs('bookings.controller')">
                {{ __('Controller') }}
            </flux:navbar.item>
        ...
        <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
            ...
            <flux:dropdown position="top" align="end">
                <flux:tooltip :content="__('Translation')" position="bottom">
                    <flux:navbar.item class="h-10 max-lg:hidden [&>div>svg]:size-5" icon="language"
