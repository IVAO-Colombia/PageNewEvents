<div class="min-h-screen py-8">
    ...
    <div class="container mx-auto px-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg">
            ...
            <div class="relative">
                <img class="w-full h-64 md:h-80 lg:h-96 object-cover" src="{{ Storage::url($event->imagen) }}"
                    alt="{{ $event->name }}">
                <div
                    class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent md:hidden flex flex-col justify-end p-4">
            ...
            <div class="p-6">
                ...
                <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 mb-6">
                    <h3 class="text-lg font-medium text-blue-800 dark:text-blue-200 mb-3">{{ __('Time Remaining') }}
                    </h3>
                    <div class="flex flex-wrap justify-center md:justify-start gap-4 lg:gap-8" id="countdown-container">
                        <div class="bg-white dark:bg-gray-700 rounded-lg shadow px-4 py-2 text-center min-w-[80px]">
                            <span class="block text-3xl lg:text-4xl font-bold text-blue-600 dark:text-blue-400"
                ...
                <div class="flex justify-center md:justify-start mt-5 mb-4">
                    <a href="{{ route('search.bookings', ['event' => $event->slug]) }}"
