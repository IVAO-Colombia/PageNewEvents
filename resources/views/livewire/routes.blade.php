        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                ...
                <div class="w-full md:max-w-xs">
                    <div class="relative">
                        ...
                        <input wire:model.live.debounce.300ms="searchTerm" wire:keydown.enter="search" type="search"
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <button wire:click="filterByType('all')" type="button"
                    ...
                    <button wire:click="filterByType('departure')" type="button"
                    ...
                    <button wire:click="filterByType('arrival')" type="button"
                    ...
                    <button wire:click="toggleCargo" type="button"
            ...
            <div class="bg-gradient-to-r from-blue-900 to-black w-full rounded-lg overflow-hidden mb-6">
                <div class="flex flex-col sm:flex-row justify-between items-center p-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button wire:click="filterByScope('all')" type="button"
                        ...
                        <button wire:click="filterByScope('national')" type="button"
                        ...
                        <button wire:click="filterByScope('international')" type="button"
            ...
            <div wire:loading.remove
                class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                {{ \Carbon\Carbon::parse($route->hourDestination)->format('H:i') }} UTC
                            </td>
                            <td class="px-6 py-4">
                                <div
                                    class="w-[44px] h-[40px] p-2 rounded-lg {{ $route->type === 'departure' ? 'bg-amber-300' : 'bg-green-500' }} text-center text-white font-bold">
                                    {{ $route->gate_origin }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                ...
                                <a
                                    class="text-white bg-red-600 hover:bg-red-700 font-medium rounded-lg text-sm px-3 py-1.5 focus:outline-none">
                                    {{ __('Reserved') }}
                                </a>
                                @else
                                <a href="{{ route('details.booking', ['hash' => \Illuminate\Support\Facades\Route::obfuscateId($route->id)]) }}"
                                    class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-3 py-1.5 focus:outline-none cursor-pointer">
                                    {{ __('Book') }}
                                </a>
                                @endif
                            </td>
