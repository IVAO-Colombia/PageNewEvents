<div class="w-full bg-white dark:bg-gray-800 py-6">
            ...
            <div
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-medium text-white">{{ $booking->event->name }}</h3>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium dark:text-white">
                                {{ \Carbon\Carbon::parse($booking->event->start_time)->format('d M Y, H:i') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                <div class="text-lg font-semibold dark:text-white">{{ $booking->Departure }}</div>
                                ...
                                <div class="text-lg font-semibold dark:text-white">{{ $booking->Arrival }}</div>
                            </div>
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div>
                            ...
                            <p class="font-medium dark:text-white">{{ $booking->Callsign }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <a href="{{ route('details.booking',['hash' => \Illuminate\Support\Facades\Route::obfuscateId($booking->route->id)]) }}"
                    ...
                    <button type="button" wire:click="CanceledReservation('{{ $booking->route->id }}')"
                    ...
                    <a href="https://dispatch.simbrief.com/options/custom?orig={{ $booking->Departure }}&dest={{ $booking->Arrival }}"
                        target="_Blank"
    ...
    <!-- Estado vacío -->
    <div
        class="bg-white dark:bg-gray-700 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-8 text-center">
        <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 dark:bg-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-600 dark:text-blue-300" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
