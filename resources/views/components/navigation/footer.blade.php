...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="text-center">
    <div>
      <a class="flex-none text-xl font-semibold text-black poppins-extrabold" href="https://co.ivao.aero/" aria-label="Brand">IVAO CO</a>
    </div>
    <!-- End Col -->

    <div class="mt-3">
      <p class="text-gray-500 poppins-medium">
        © 2025 IVAO CO.
      </p>
    </div>
